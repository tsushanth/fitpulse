...
enum StoreKitProductID: String, CaseIterable {
    case monthly = "com.appfactory.fitpulse.premium.monthly"
    case yearly = "com.appfactory.fitpulse.premium.yearly"
    case lifetime = "com.appfactory.fitpulse.premium.lifetime"
...
extension Product {
    ...
    var savingsLabel: String? {
        ...
        return subscription.subscriptionPeriod.unit == .year ? "Best Value" : nil
    }
}
